...
const Sidebar = (props: Props) => {
    ...
    return (
        <>
            ...
            <aside ref={sidebarRef} className="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-primary-800 ">
                ...
                <button onClick={openNav} className="-right-6 transition transform ease-in-out duration-500 flex border-4 border-white bg-primary-800 hover:bg-yellow-500 absolute top-2 p-3 rounded-full text-white hover:rotate-45">
